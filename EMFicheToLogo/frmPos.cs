...
namespace EMFicheToLogo
{
    public partial class frmPos : Form
    {
        ...
        private void btnList_Click(object sender, EventArgs e)
        {
            ...
            List<Model.PosSummary> posReturns = GetPosItems(dt);
        ...
        private List<Model.PosSummary> GetPosItems(DataTable pDt)
        {
        ...
        private List<Model.PosSummary> PrepareItems(List<Model.PosSummary> pPosReturnInsurance)
        {
            ...
            var grpInsurance = pPosReturnInsurance.Where(f => f.DebitTotal > 0m)
            ...
            foreach (var insuranceItem in grpInsurance)
            {
                ...
                if (firm == null)
                {
                    result.Add(new Model.PosSummary()
                    {
                        ...
                        DebitCode = "",
                        CreditCode = "",
                        DebitCodeDefn = insuranceItem.InsuranceFirm,
                        CreditCodeDefn = "",
                        DebitTotal = 0m,
                        CreditTotal = 0m,
                        Status = (int)Model.ListStatus.HasError,
                ...
                result.Add(new Model.PosSummary()
                {
                    ...
                    DebitCodeDefn = insuranceItem.InsuranceFirm,
                    CreditCodeDefn = "",
                    DebitTotal = insuranceItem.TotalDebit,
                    CreditTotal =0m,
                ...
                result.Add(new Model.PosSummary()
                {
                    InsuranceFirm = insuranceItem.InsuranceFirm,
                    DebitCode = "",
                    CreditCode = otherSett.BRANCHCLCODE,
                    DebitCodeDefn = "",
                    CreditCodeDefn = "ŞUBELER CARİ HES.",
                    DebitTotal = 0m,
                    CreditTotal = insuranceItem.TotalDebit,
                    Status = (int)Model.ListStatus.ListOK,
                    StatusDesc = ""
                });
